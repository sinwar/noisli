$(document).ready(function() {
    ...
    var soundbyuserElement = document.createElement('audio');
    soundbyuserElement.setAttribute('src', $('.playsoundbyuser').attr('id'));
    $('.playsoundbyuser').click(function() {

            console.log("$('.playsoundbyuser').attr('id')");
            
        
            soundbyuserElement.play();
